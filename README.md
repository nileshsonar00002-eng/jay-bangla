# 🎪 खान्देशी जत्रा (Khandeshi Jatra)

> “मना गाव, मना देश, जय खान्देश”

A single-page music landing website dedicated to popular Khandeshi & Ahirani songs, built with high-transparency glassmorphism, subtle cinematic animations, real-time presence tracking, and an interactive micro-celebration experience.
...
- **Interactive Click Effects**:
  ...
  - Every 10th click triggers a glowing golden **“जय खान्देश”** celebration!
- **Keyboard Shortcuts**:
  - `Space` : Play / Pause
...
Simply clone the repository and open `index.html` in any modern web browser or serve with:
